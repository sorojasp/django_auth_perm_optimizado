...
SECRET_KEY = 'y0klv@ek_0(%kd%3vtrr(qi+r&7(_p(866wj9t7n)g1dilk5@4'
...
INSTALLED_APPS = [
    ...
    'rest_framework.authtoken',  #se hace una tabla de tokens y la relaciona con los user
